...
const routes: Routes = [
  ...
  { path: "viewapplicants/:jobId", component: ViewapplicantsComponent, canActivate: [AuthGuard] },
  { path: "viewapplicant/:userId", component: ViewapplicantsprofileComponent, canActivate: [AuthGuard] },
